/*
 * SimpleDemo_Debug - Wersja debug z diagnostyką
 * 
 * Ta wersja pomaga zdiagnozować problemy z komunikacją
 */
...
void setup() {
    ...
    Serial.println("- Check Serial Monitor for packet hex");
    Serial.println("- Look for: [MTRX TX] AA 01 ...");
    Serial.println("- If you see packets, hardware is OK");
    Serial.println("- If no packets, check connections");
    Serial.println("========================================\n");
